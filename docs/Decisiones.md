...
<p align="justify">
Ya en la zona donde se despliega la información detallada de la galería seleccionada en cuestión, se le entrega un poco más de control al usuario permitiéndole controlar un carrusel de imágenes o videos con piezas llamativas de la galería y más abajo en la sección de descripción también se puede descargar un documento con la información básica de la galería permitiéndole a dispositivos que cuenten con dificultades de conexión tener acceso a toda la información
</p>

<p align="justify">
He de comentar también que los recuadros de la sección de listado de galerías son una muestra ideal de la implementación del principio de modularidad ya que un mismo espacio puede ser utilizado para n-cantidad de galerías, facilitando a futuro el manteniendo y la actualización del software.
</p>

<p align="justify">
Algunas otras de las decisiones de diseño serán explicadas en el video introductorio a la aplicación en donde se leerán los casos específicos que ayudaron a su implementación.
</p>
